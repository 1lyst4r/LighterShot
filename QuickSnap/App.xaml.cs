...
public partial class App : Application
{
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        singleInstanceMutex = new Mutex(true, "LightlyShot.SingleInstance", out ownsSingleInstanceMutex);
    ...
    private async void StartCapture()
    {
        ...
        try
        {
            ...
            if (delaySeconds > 0)
            {
                trayIcon.ShowInfo("LightlyShot", $"Taking a screenshot in {delaySeconds} seconds...");
    ...
    private void OnUnexpectedError(object sender, DispatcherUnhandledExceptionEventArgs e)
    {
        ...
        trayIcon?.ShowError("LightlyShot hit a problem", e.Exception.Message);
        e.Handled = true;
    }
}
